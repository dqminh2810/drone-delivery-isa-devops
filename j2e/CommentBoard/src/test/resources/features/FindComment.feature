Feature: Find comment
  ...
  Background:
    Given some deliveries with date 2026-05-20 time 12:30 and with UIDL45A as package and with date 2026-07-20 time 15:30 and with UIDL45U as package with LePosta as Supplier and 1 as drone and a comment for delivery UIDL45A with rating 4 and comment Ok ca va !
